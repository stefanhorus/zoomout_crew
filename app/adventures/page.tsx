...
const adventures: Adventure[] = [
  ...
  },
  {
    ...
    shortDescription: "A perfect escape from overpopulated London city, this two-day trip to Edinburgh offered a refreshing change of pace. We explored the historic Scottish capital, discovering its charming streets, iconic landmarks, and breathtaking views that provided a much-needed break from the hustle and bustle of city life.",
