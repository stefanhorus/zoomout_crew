...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "about.mission.text2": "Our passion for aerial videography drives us to deliver exceptional quality and creative vision that elevates your content above the rest.",
  ...
  ro: {
    ...
    "about.mission.text1": "La Zoomout_crew, ne specializăm în captarea unor cadre aeriene uimitoare care îți spun povestea dintr-o perspectivă unică. Fie că sunt prezentări imobiliare, acoperire de evenimente, proiecte comerciale sau aventuri cinematice, aducem videografie profesională cu drona la fiecare proiect.",
    "about.mission.text2": "Pasiunea noastra pentru videografia aeriana ne determina sa livram calitate exceptionala si viziune creativa care ridica continutul tau deasupra restului.",
    ...
    "about.professionalEquipment.desc": "Drona și sisteme de camere de ultimă generație pentru cadre de cea mai înaltă calitate.",
