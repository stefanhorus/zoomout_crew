...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "about.reviews.review1.text": "Exceptional quality and professionalism. The aerial footage exceeded all our expectations!",
    "about.reviews.review1.name": "John Doe",
    "about.reviews.review1.initials": "JD",
    "about.reviews.review1.role": "Event Organizer",
  ...
  ro: {
    ...
    "about.reviews.review1.text": "Calitate excepțională și profesionalism. Filmările aeriene au depășit toate așteptările noastre!",
    "about.reviews.review1.name": "Ion Popescu",
    "about.reviews.review1.initials": "IP",
    "about.reviews.review1.role": "Organizator Evenimente",
